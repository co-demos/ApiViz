...
@click.option('--backend', 	default="local", 	  	nargs=1,	help="The <backend> you need to run the app : local, distant, standalone" )
...
def app_runner(mode, backend, host, port, https) :
  """
  app_runner
  ...
  os.environ["BACKEND_MODE"] = backend
